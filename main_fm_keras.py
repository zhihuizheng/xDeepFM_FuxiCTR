...
from fuxictr.keras import models
import gc
import argparse
import logging
import os
...
if __name__ == '__main__':
    ...
    parser.add_argument('--version', type=str, default='tensorflow', help='The model version.')
    parser.add_argument('--config', type=str, default='./config/fm_criteo_x1', help='The config directory.')
    parser.add_argument('--expid', type=str, default='FM_criteo_x1', help='The experiment id to run.')
    ...
    with tf.Session(config=session_conf) as sess:
        ...
        # fit the model
        model.fit_generator(sess, train_gen, validation_data=valid_gen, **params)
        ...
        valid_result = model.evaluate_generator(sess, valid_gen)
