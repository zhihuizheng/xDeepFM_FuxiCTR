...
class BaseModel(object):
    ...
    def train_one_epoch(self, sess, data_generator, epoch):
        ...
        for batch_index, batch_data in enumerate(batch_iterator):
            loss, accuracy = self.model.train_on_batch(batch_data[0], batch_data[1])
            epoch_loss += loss
    ...
    def evaluate_generator(self, sess, data_generator):
        ...
        for batch_data in data_generator:
            ...
            yp = self.model.predict(batch_data[0], batch_size=128)
            y_pred.extend(yp)
    ...
    def count_parameters(self):
        # https://blog.csdn.net/Jolen_xie/article/details/109382004
        total_parameters = 0
